...
namespace restAPI.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            // CreateAsync will automate Salt and Hash the password using Microsoft standards.
        ...
        private async Task<AuthenticationResult> GenerateAuthResultForUserAsync(IdentityUser user)
        {
            ...
            // What the token should include/return to the user
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                // Claims = property that tell things the user has to know
                Subject = new ClaimsIdentity(claims),
                Expires = DateTime.UtcNow.AddMinutes(30), //Add(_jwtSettings.TokenLifetime),
